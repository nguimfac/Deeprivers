...
As it's name, it will remove query string from static resources. Static resources are JavaScript and CSS files. It improves speed of WordPress website. And also it improves speed score in website testing tools like Pingdom, GTmetrix, PageSpeed, YSlow etc.
